...
const Banner = () => {
  return (
    <div className="bg-[linear-gradient(to_right_bottom,rgba(0,0,1,0.8),rgba(0,0,1,0.8)),url('https://demo.ovatheme.com/dvents/wp-content/uploads/2017/06/bg-1-1.jpg')] w-full h-[80vh] bg-center overflow-hidden bg-cover relative">
